...
public class DefaultContextAssociationManager implements ContextAssociationManager, Serializable {
  ...
  private final static Logger log = LoggerFactory.getLogger(DefaultContextAssociationManager.class.getName());
  ...
  public void setExecution(Execution execution) {
    ...
    if (log.isDebugEnabled()) {
      log.debug("Associating {} (@{})" , execution, scopedAssociation.getClass().getAnnotations()[0].annotationType().getSimpleName());
    }
